...
SECRET_KEY = config('SECRET_KEY', default='unsafe-default-key-please-change-in-env')
...
INSTALLED_APPS = [
    ...
    'apps.tickets',
    'apps.checklists',
    'apps.users', # Ensure this is explicitly listed if it's a separate app
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='it_db'),
